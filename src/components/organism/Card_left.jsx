            ...
            <img src={photo} alt="" />
                ...
                <div className="col_">
                    ...
                    <div className="right_">
                        <p className="desc_">
                        Las emociones, son importantes en el día a día de una persona, ya que nos
                         permiten orientar nuestras acciones de una manera eficaz, además nos entregan
                          conocimientos respecto a nuestro entorno y de nosotros mismos, permitiendo
                           la toma de decisiones ante diferentes situaciones que estemos pasando en
                            cualquier momento.
                        </p>
                    </div>
                </div>
